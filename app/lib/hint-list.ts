...
const experimentHints: HintEntry[] = [
  ...
  { id: "real-3-1", lessonId: "real", index: 3, title: "32ビットの浮動小数点に分解する", kind: "実験" },
  ...
  { id: "text-3-1", lessonId: "text", index: 3, title: "ビット数と表せる文字の種類", kind: "実験" },
  ...
  { id: "image-3-1", lessonId: "image", index: 3, title: "ドット絵を描いて、色数とデータ量の関係を見る", kind: "実験" },
  ...
  { id: "spread-2-1", lessonId: "spread", index: 2, title: "z得点を求める", kind: "実験" },
