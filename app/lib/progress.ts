...
//   ・学び直し（確認問題／重要語句を1単元ぶん解き直す） … 10G
//
// 学び直しについて
//   ・払った10Gは戻りません。解き直して正解しても、Gは新たに入りません
//     （リセットの瞬間に、その単元でかせいだGを凍結して固定します）
//   ・そのため「リセット→満点→またリセット」でGを無限に増やすことはできません
//   ・点数と正誤は上書きされるので、学び直した成果はきちんと成績に反映されます
//
